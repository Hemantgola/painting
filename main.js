...
var new_height= height - 300;
    ...
    function my_touchstart(e)
    {
        ...
        var last_position_of_x = e.clientY - canvas.offsetLeft;
        var last_position_of_y = e.clientX - cancas.offsetTop;
    ...
    console.log("Last position of x and y coodinaes = ");
    console.log("x = "  + last_position_of_x + "y = "  + last_position_of_y);
